...
describe("DateRange Value Object", () => {
  ...
  it("deve criar uma instância de DateRange com a data de início de a data de término e verificar o retorno dessas datas", () => {
  ...
  it("deve calcular o total de noites", () => {
    const startDate = new Date("2024-12-20");
    const endDate = new Date("2024-12-25");
    const dateRange = new DateRange(startDate, endDate);
